...
public class CreateSpringPortletTemplateModel extends CreateWebClassTemplateModel
{
    protected boolean generateGenericInclude = false;

    public CreateSpringPortletTemplateModel( IDataModel dataModel )
    {
        super( dataModel );
    }
    ...
    {
        return dataModel.getStringProperty( INewSpringPortletClassDataModelProperties.PORTLET_NAME );
    }
