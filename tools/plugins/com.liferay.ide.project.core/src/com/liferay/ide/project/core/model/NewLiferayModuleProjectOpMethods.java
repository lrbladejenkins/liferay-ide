...
public class NewLiferayModuleProjectOpMethods
{
    ...
    public static final Status execute( final NewLiferayModuleProjectOp op, final ProgressMonitor pm )
    {
        ...
        try
        {
            final LiferayModuleProjectProvider projectProvider = op.getProjectProvider().content( true );
    ...
    public static boolean canUseCustomLocation( NewLiferayModuleProjectOp op )
    {
