 ...
 * @author Simon Jiang
 */
public class PluginProjectGroupIdDefaultValueService extends GroupIdDefaultValueService
{
    ...
    {
        return ProjectCore.PREF_DEFAULT_PLUGIN_PROJECT_MAVEN_GROUPID;
    }
    ...
    protected String getMavenParentPomVersion()
    {
        ...
        if( location != null )
        {
            ...
            return NewLiferayPluginProjectOpMethods.getMavenParentPomGroupId( op, projectName, parentProjectOsPath );
